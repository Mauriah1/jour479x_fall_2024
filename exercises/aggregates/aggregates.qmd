...
**Answer**: The output provided a chart that shows each player there position, age, team, alongside some other basketball stats.
...
**Answer**: Shooting guards have the highest amount of players in there position with 162, behind them are centers with 139, and with the least amount of players per position is power-forwards.
...
**Answer**: A complicating factor is how many players have multiple positions. This could be resolved by making the player one position.
...
So wait, what team is TOT? It's not a team its the total column for players who were on more than one team.
...
Why? Because the game may start with center but the average center doesn't stay in for a while.
...
**ANSWER:** I am intrigued by the center position. I say this because they have one of the lowest average of minutes for play but they also have one of the most max minutes. This showed me that center may not be as athletic as other positions but there role is still important.
